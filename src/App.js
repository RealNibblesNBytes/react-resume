...
const ProfilePanel = (props) =>{
  return(
    <>
      <div id="panel-bg">
        <a href="https://www.linkedin.com/in/israel-mendoza-43455a20b/" rel="noreferrer" target="_blank"><img title="Linked In Profile" id="profile-picture" alt="linkedin profile"src={profile}></img></a>
        <h1 id="name">Israel Mendoza</h1>
